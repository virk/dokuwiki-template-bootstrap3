/*!
 * DokuWiki Bootstrap3 Template: FontAwesome v4 to v5 migration script
 *
...
var fa4to5 = [
  // FA v4 icon              FA v5 icon                             FA v5 category
  ...
  [ 'paypal', 'paypal', 'fab' ], // Moved to fab category

];

jQuery(document).ready(function() {

  jQuery.each(fa4to5, function(idx, icon) {
    jQuery('.fa.fa-' + icon[0])
      .addClass(icon[2]).addClass('fa-' + icon[1])
      .removeClass('fa').removeClass('fa-' + icon[0]);
  });
